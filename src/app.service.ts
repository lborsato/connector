...
export class AppService {
  ...
  getTransactions(
    ...
    html += '<tr><th>' + Date.now().toLocaleString('en-US') + '</th><th>Nespresso</th><th>$25.88</th></tr>';
    html += '<tr><th>' + Date.now().toLocaleString('en-US') + '</th><th>Ralphs</th><th>$101.22</th></tr>';
    html += '<tr><th>' + Date.now().toLocaleString('en-US') + '</th><th>Best Buy</th><th>$722.22</th></tr>';
    html += '</table>';
    return html;
  }
